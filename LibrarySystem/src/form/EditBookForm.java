 ...
 * @author quangns
 */
public class EditBookForm extends javax.swing.JFrame implements BookInterface{
    private StoreBook editbook;
    /**
     * Creates new form EditBookForm
     */
    public EditBookForm() {
        initComponents();
        new ControlBook(this);
    }

    EditBookForm(String bid, String title, String publisher, String author, String price) {
        initComponents();
        new ControlBook(this).GetInfoEditBook(bid, title, publisher, author, price);
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            new ControlBook(this).UpdateBook(editbook);
            this.setVisible(false);
            new ManageBookForm().setVisible(true);
